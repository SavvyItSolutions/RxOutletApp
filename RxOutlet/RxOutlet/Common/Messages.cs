...
namespace RxOutlet.Common
{
    public static class Messages
    {
        ...
        public const string PswLength = "Passwords must be at least 6 characters.";
        public const string PswNonChar = "Passwords must have at least one non letter or digit character.";
        public const string PswNo = "Passwords must have at least one digit ('0'-'9').";
        public const string PswAlp = "Passwords must have at least one uppercase ('A'-'Z').";
